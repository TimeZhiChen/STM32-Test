...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(OLED_SCL_GPIO_PORT,OLED_SCL_GPIO_PIN, (GPIO_PinState)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(OLED_SDA_GPIO_PORT,OLED_SDA_GPIO_PIN, (GPIO_PinState)BitValue);
